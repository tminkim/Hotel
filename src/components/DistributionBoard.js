  ...
  return (
    <>
      ...
      >
        {selectedBoard && (
          <>
            <button onClick={closeModal} className="close-button fixed top-4 right-4">X</button>
            <div className="modal-content p-4 overflow-y-auto max-h-[90vh]"> {/* 모달 내부에서만 스크롤 가능 */}
